...
import ch.so.agi.dsmocclusion.core.TileProcessor;
import ch.so.agi.dsmocclusion.output.SingleFileAccumulator;
import ch.so.agi.dsmocclusion.output.TileWriter;
import ch.so.agi.dsmocclusion.output.TiledTileWriter;
import ch.so.agi.dsmocclusion.raster.RasterMetadata;
import ch.so.agi.dsmocclusion.raster.RasterSource;
import ch.so.agi.dsmocclusion.tiling.TilePlan;
import ch.so.agi.dsmocclusion.tiling.TilePlanner;
...
import ch.so.agi.dsmocclusion.util.ScheduledHeartbeatScheduler;
...
public final class OcclusionPipeline {
    ...
    public OcclusionPipeline(ConsoleLogger logger, Clock clock) {
        this(new TilePlanner(), new TileProcessor(), logger, clock, () -> new ScheduledHeartbeatScheduler("dsm-occlusion-heartbeat"));
    }
