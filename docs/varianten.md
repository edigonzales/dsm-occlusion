...
```
$
./gradlew run --args="render compose --style /Users/stefan/sources/dsm-occlusion/docs/style-variante-c-2.json --bbox 2592000,1213000,2645000,1262000 --output-mode tile-files --output /Users/stefan/tmp/dsm_variante_c_2 --tile-size 1000 --with-alpha" -Dorg.gradle.jvmargs=-"Xmx4g"
